...
return {
  {
    name = "edit session imports malformed continuation lines into the editor pane",
    fn = function()
        ...
        run_with_docstring_gate_stub(function()
          run_with_context_stub(nil, function()
            ...
            local ok, err = xpcall(function()
              ...
              t.assert_deep_equal(vim.api.nvim_buf_get_lines(active.editor_bufnr, 0, -1, false), {
                'cigar_str = "27S89M1I11M"',
                "assert parse_cigar(cigar_str) == [",
                '    ("27", "S"),',
                '    ("89", "M"),',
